...
- **haberler = mercury.png** (2026-09-26): Giambologna Merkür fotoğrafı (MarkPagl, CC BY-SA 4.0) + canvas ile çizilmiş "DAILY NEWS" gazetesi kolajı, 859×483 (tuval genişliği, 1:1). ESER tablosunda `w`/`h` alanı; <1280 px yumuşak ölçekleme. Betik scratchpad `sanat/merkur.html`, `merkur-surucu.mjs`, `p5.json` (segmentasyon eşiği 70, olcek .1436). İletişim Elçiler ile kaldı.
